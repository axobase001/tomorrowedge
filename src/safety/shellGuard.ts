...
const allowedExecutables = new Set(["npm", "node", "npx", "pnpm", "yarn", "python", "python3", "pytest", "tsx", "tsc", "vitest", "jest"]);
const shellMetacharacters = /[;&|`<>]|\$\(|\r|\n/;

export function assessShellCommand(command: string): ShellRisk {

...
TomorrowEdge is the full-access engineering cockpit for heterogeneous coding
agents.

It is not a general personal-agent runtime.

Core positions:

- Strong agents should decide.
...
tasks with heterogeneous model teams.

...
- `1.4.0` introduces the Adaptive Orchestration Runtime: validated TaskGraphs on plans, RoleGraphScheduler node-result tracing, evidence dependency gap events, Debate Protocol v2 resolution, policy counterfactual replay/tournament events, external agent adapters for generic/Codex/Claude Code outputs, and a unified model-invocation BudgetGate.
...
plans, RoleGraphScheduler node-result tracing, evidence dependency gap events,
Debate Protocol v2 resolution, policy counterfactual replay/tournament events,
external agent adapters for generic/Codex/Claude Code outputs, and a unified
model-invocation BudgetGate.
